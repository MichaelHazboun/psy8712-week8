...
An image of this project as of *`r Sys.Date()`* can be accessed by [clicking this link](https://notebooks.gesis.org/binder/jupyter/user/michaelhazboun-psy8712-week8-7ixv3oe7/rstudio/). 
